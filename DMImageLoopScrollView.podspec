#
#  Be sure to run `pod spec lint DMImageLoopScrollView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of DMImageLoopScrollView in Markdown format.
  ...
  s.homepage     = "https://github.com/caojun/DMImageLoopScrollView"
  ...
  s.source       = { :git => "https://github.com/caojun/DMImageLoopScrollView.git", :tag => s.version.to_s }
